...
function init() {
  ...
  document.getElementById('adv_mainContainer').style.zIndex = 9999;
  ...
  setUpIMA();
  console.log("document.getElementById('adv_mainContainer').style.zIndex " + document.getElementById('adv_mainContainer').style.zIndex)
}
