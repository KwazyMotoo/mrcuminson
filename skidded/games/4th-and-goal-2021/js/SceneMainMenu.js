      ...
      if (this.sys.game.device.os.desktop){
       ...
       mobile = true;
        ...
        this.btnPlay.setOrigin(0.5,0);
          ...
          this.btnPickTeams = this.add.sprite(426,290,"buttonPickTeams1");
        this.btnPickTeams.setOrigin(0.5,0);
         ...
         this.btnPlayoffSeason = this.add.sprite(426,345,"buttonPlayoffSeason1");
         this.btnPlayoffSeason.setOrigin(0.5,0);
          ...
          this.btnInstructions = this.add.sprite(426,400,"buttonInstructions1a");
        this.btnInstructions.setOrigin(0.5,0);
