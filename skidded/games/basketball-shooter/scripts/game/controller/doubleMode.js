...
Red.DoubleMode = (function ()
{
    ...
    function DoubleMode(game)
    {
        ...
        this.turn = 0;
        this.turnInfo = { offenceTeam : _teamID.none, chance : 3 };
    ...
    DoubleMode.prototype = {
        ...
        start : function ()
        {
            ...
            this.scoreBoard.setMode( Red.GameMode.double );
        },
        ...
        _sleepBall : function ()
        {
            ...
            if( this.turnInfo.offenceTeam === this.catchBallTeamID )
            {
                ...
                {
                    //공격기회 끝남.
                    //this.game.signalManager.getSignal( EVENT_SIGNAL.onChangeTurn).dispatch();
