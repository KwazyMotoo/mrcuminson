class SceneStadium extends Phaser.Scene {
    ...
    preload() {
      this.load.image('buttonSound1', 'content/buttonSound1.png');
        ...
        this.load.spritesheet('player',playerGraphics[0],{frameWidth:20,frameHeight:20});
        this.load.spritesheet('player2',playerGraphics[1],{frameWidth:20,frameHeight:20});
    ...
    create() {
      ...
      if(!musicLoaded){
        ...
        this.container.add([this.field,this.firstDownLine, this.lineOfScrimmage, this.circle, this.targetA, this.targetS, this.targetD]);
        ...
        this.textScoreTeam1 = this.add.text(200, 5, scoreTeam1, { fontFamily: 'Arial', fontSize: 18, color: '#ffffff' });
        //this.textScoreTeam1.font = "Arial";
        this.textScoreTeam1.setOrigin(1.0, 0.0);
        this.textScoreTeam2 = this.add.text(200, 35, scoreTeam2, { fontFamily: 'Arial', fontSize: 18, color: '#ffffff' });
        ...
        //stats...
        this.stats = this.add.text(106, 185, "Game Statistics", { fontFamily: 'Arial', fontSize: 18, color: '#ffff00' });
        this.stats.setOrigin(0.5, 0.0);
        this.statsInterceptions = this.add.text(30, 210, "Interceptions", { fontFamily: 'Arial', fontSize: 12, color: '#ffffff' });
        this.statsInterceptions.setOrigin(0.0, 0.0);
        this.statsInterceptionsNum = this.add.text(180, 210, statsInterceptions, { fontFamily: 'Arial', fontSize: 12, color: '#ffffff' });
        this.statsInterceptionsNum.setOrigin(1.0, 0.0);
        this.statsPassYards = this.add.text(30, 235, "Pass Yards", { fontFamily: 'Arial', fontSize: 12, color: '#ffffff' });
        this.statsPassYards.setOrigin(0.0, 0.0);
        this.statsPassYardsNum = this.add.text(180, 235, statsPassYards, { fontFamily: 'Arial', fontSize: 12, color: '#ffffff' });
        this.statsPassYardsNum.setOrigin(1.0, 0.0);
        this.statsRushYards = this.add.text(30, 260, "Rush Yards", { fontFamily: 'Arial', fontSize: 12, color: '#ffffff' });
        this.statsRushYards.setOrigin(0.0, 0.0);
        this.statsRushYardsNum = this.add.text(180, 260, statsRushYards, { fontFamily: 'Arial', fontSize: 12, color: '#ffffff' });
        this.statsRushYardsNum.setOrigin(1.0, 0.0);
        this.statsCompletions = this.add.text(30, 285, "Completions", { fontFamily: 'Arial', fontSize: 12, color: '#ffffff' });
        this.statsCompletions.setOrigin(0.0, 0.0);
        this.statsCompletionsNum = this.add.text(180, 285, statsCompletions, { fontFamily: 'Arial', fontSize: 12, color: '#ffffff' });
        this.statsCompletionsNum.setOrigin(1.0, 0.0);
        this.statsTouchdowns = this.add.text(30, 310, "Touchdowns", { fontFamily: 'Arial', fontSize: 12, color: '#ffffff' });
        this.statsTouchdowns.setOrigin(0.0, 0.0);
        this.statsTouchdownsNum = this.add.text(180, 310, statsTouchdowns, { fontFamily: 'Arial', fontSize: 12, color: '#ffffff' });
        this.statsTouchdownsNum.setOrigin(1.0, 0.0);
        this.statsTotalYards = this.add.text(30, 335, "Total Yards", { fontFamily: 'Arial', fontSize: 12, color: '#ffffff' });
        this.statsTotalYards.setOrigin(0.0, 0.0);
        this.statsTotalYardsNum = this.add.text(180, 335, statsTotalYards, { fontFamily: 'Arial', fontSize: 12, color: '#ffffff' });
        this.statsTotalYardsNum.setOrigin(1.0, 0.0);
        if(time == 300){this.textTime = this.add.text(200, 61, '5:00', { fontFamily: 'Arial', fontSize: 18, color: '#000000' });}
        if(time == 600){this.textTime = this.add.text(200, 61, '10:00', { fontFamily: 'Arial', fontSize: 18, color: '#000000' });}
        if(time == 900){this.textTime = this.add.text(200, 61, '15:00', { fontFamily: 'Arial', fontSize: 18, color: '#000000' });}
        ...
        //TEAM 1 initialize
        this.qb = new QB(this,320,460,"player");this.qb.setData("startX", 320);this.qb.setData("startY", 1200);
        this.fb = new FB(this,320,420,"player");this.fb.setData("startX", 200);this.fb.setData("startY", 840);
        this.tb = new TB(this,340,460,"player");this.tb.setData("startX", 320);this.tb.setData("startY", 1320);
        this.wr1 = new WR1(this,280,420,"player");this.wr1.setData("startX", 150);this.wr1.setData("startY", 780);
        this.wr2 = new WR2(this,360,420,"player");this.wr2.setData("startX", 490);this.wr2.setData("startY", 780);
        this.wr3 = new WR3(this,300,420,"player");this.wr3.setData("startX", 440);this.wr3.setData("startY", 840);
        this.lt = new LT(this,280,400,"player");this.lt.setData("startX", 100);this.lt.setData("startY", 660);
        this.lg = new LG(this,300,400,"player");this.lg.setData("startX", 200);this.lg.setData("startY", 660);
        this.c = new C(this,320,400,"player");this.c.setData("startX", 320);this.c.setData("startY", 660);
        this.rg = new RG(this,340,400,"player");this.rg.setData("startX", 440);this.rg.setData("startY", 660);
        this.rt = new RT(this,360,400,"player");this.rt.setData("startX", 540);this.rt.setData("startY", 660);
        //TEAM 2 initialize
        this.db1 = new DB1(this, 260,240,"player2");this.db1.setData("startX", 50);
        this.db2 = new DB2(this, 380,240,"player2");this.db2.setData("startX", 590);
        this.ss = new SS(this, 280,240, "player2");this.ss.setData("startX", 100);
        this.fs = new FS(this, 360,240, "player2");this.fs.setData("startX", 540);
        this.lb1 = new LB1(this, 300,240,"player2");this.lb1.setData("startX", 150);
        this.lb2 = new LB2(this, 320,180,"player2");this.lb2.setData("startX", 320);this.lb2.setData("startY", 440);
        this.lb3 = new LB3(this, 340,240,"player2");this.lb3.setData("startX", 490);
        this.dl1 = new DL1(this, 280,220,"player2");this.dl1.setData("startX", 200);
        this.dl2 = new DL2(this, 360,220,"player2");this.dl2.setData("startX", 440);
        this.dl3 = new DL3(this, 300,220,"player2");this.dl3.setData("startX", 250);
        this.dl4 = new DL4(this, 340,220,"player2");this.dl4.setData("startX", 390);
...
slowDown(player1, player2){
  ...
  if(player2 == ballCarrier){
    ...
    update(){
      ...
      if(offensiveTeam == 1){
        //this.circle.x = this.lb2.x; this.circle.y = this.lb2.y;
        if(ballCarrier != null){
        ...
        if(ballSnapped){
          ...
          if(ballCarrier != null && !tackled){
            ...
            if(this.keySpace.isDown && !mobileSpin){canSpin = false;}else{canSpin = true;}
              if((this.keyW.isDown || mobileBoost) && speedBoost > 0){ballCarrier.setData("speed",ballCarrier.getData("speedOriginal") + 0.5);speedBoost -= 0.5;this.speedBar.setScale(1, speedBoost/100);
      ...
      if(kickOffStarted && kickReturnTeam == 2){
        if(!ballSnapped){
          ...
          if((this.keyW.isDown || mobileBoost) && speedBoost > 0){
            if(this.qb.getData("speed") < this.qb.getData("speedOriginal") + 0.5){this.qb.setData("speed",this.qb.getData("speed")+0.1)}
            //this.qb.setData("speed",this.qb.getData("speedOriginal") + 0.5);
            speedBoost -= 0.5;
