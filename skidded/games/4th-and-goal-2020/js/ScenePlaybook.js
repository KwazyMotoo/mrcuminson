        ...
        this.btnReturnMiddle = this.add.sprite(440,150,"button1");
         ...
         // this.btnDeepKick.setOrigin(0,0);
          ...
          this.buttonBack.on("pointerup", function() {
            openOffensivePlaybook = true;
            openOffensiveFormations = true;
            openOffensivePlaysAce =false;openOffensivePlaysBunch = false;openOffensivePlaysEmpty=false;openOffensivePlaysI=false;openOffensivePlaysShotgun=false;openOffensivePlaysSplit=false;openOffensivePlaysRedZone = false;
            this.buttonBack.visible = false;
          ...
          this.btn43.on("pointerup", function() {
            if(openDefensivePlaybook && openDefensiveCoverages){
              ...
              team2RandomOffense = Math.floor(Math.random() * 14);
              //team2RandomOffense = 10;
...
//CONTAINERS...
          ...
          this.offensivePlaybook.add([this.bgOffensePlaysI,this.bgOffensePlaysSplit,this.bgOffensePlaysShotgun,this.bgOffensePlaysBunch,this.bgOffensePlaysAce,this.bgOffensePlaysEmpty,this.bgOffensePlaysRedZone, this.bgOffenseFormations]);
          this.offensivePlaybook.add([this.btnSplit,this.btnIFormation, this.btnShotgun, this.btnBunch, this.btnAce, this.btnEmpty,this.buttonBack,this.buttonRedZone]);
          this.offensivePlaybook.visible = false;
        ...
        if(openOffensivePlaybook){
          this.offensivePlaybook.visible = true;
            ...
            if(yardlinePixel <= 420 && !openOffensivePlaysSplit && !openOffensivePlaysI && !openOffensivePlaysShotgun && !openOffensivePlaysBunch
              && !openOffensivePlaysAce && !openOffensivePlaysEmpty){this.buttonRedZone.visible = true;}
