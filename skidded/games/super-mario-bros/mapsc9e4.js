...
function endCastleInsideFinal(xloc, last) {
  ...
  if(last) {
    ...
    text = stopper.text = [
      pushPreText({innerHTML: "<span class='span'>THANK YOU " + window.player.title.toUpperCase() + "!</span>", style: style}, xloc + 160, 66).object,
      pushPreText({innerHTML: "<span class='span'>YOUR QUEST IS OVER.<BR>WE PRESENT YOU A NEW QUEST.</span>", style: style}, xloc + 148, 50).object,
      pushPreText({innerHTML: "<span class='span'>PRESS BUTTON B<BR>TO SELECT A WORLD.</span>", style: style}, xloc + 148, 26).object
    ];
  }
  // ...or that jerk Toad
  else {
    ...
    text = stopper.text = [
      pushPreText({innerHTML: "<span class='span'>THANK YOU " + window.player.title.toUpperCase() + "!</span>", style: style}, xloc + 160, 66).object,
      pushPreText({innerHTML: "<span class='span'>BUT OUR PRINCESS IS IN<BR>ANOTHER CASTLE!</span>", style: style}, xloc + 148, 50).object
    ];
  }
}
