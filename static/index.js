...
function getAboutBlank() {
    if (localStorage.getItem('aboutBlank') === 'on') {
        ...
        introText.innerHTML = "<b>Elixir:</b><br>Surf The Web, Without Anyone Knowing TIW ;)</a>"

        var searchPlaceholder = document.querySelector("input");
        searchPlaceholder.placeholder = "Search It Up Babe.";
...
function setupCloak() {
    ...
    if (localStorage.getItem('cloakTitle') == null && localStorage.getItem('cloakFavicon') == null) {
        document.title = 'TIW | Theres Infinite Ways For Learning!';
...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register(window.location.origin + "static/uv-sw.js");
  }
